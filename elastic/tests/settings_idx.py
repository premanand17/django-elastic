...
IDX = {'GENE': {'indexName': 'test__gene_'+SEARCH_SUFFIX,
                'indexGene': SEARCH_TEST_DATA_PATH+'genenames.org.test.txt.gz', 'shards': 1},
       'DISEASE': {'indexName': 'test__disease_'+SEARCH_SUFFIX,
                   'indexDisease': SEARCH_TEST_DATA_PATH+'disease.list.gz', 'shards': 1},
       'MARKER': {'indexName': 'test__snp_'+SEARCH_SUFFIX,
                  'indexSNP': SEARCH_TEST_DATA_PATH+'dbsnp142_test.vcf.gz', 'shards': 1},
       'MARKER_RS_HISTORY': {'indexName': 'test__snp_merge_'+SEARCH_SUFFIX,
                             'indexSNPMerge': SEARCH_TEST_DATA_PATH+'rs_merge_test.gz', 'shards': 1},
       'JSON': {'indexName': 'test__json_'+SEARCH_SUFFIX, 'indexType': 't1d',
                'indexJson': SEARCH_TEST_DATA_PATH+'publications.json', 'shards': 1},
       'GFF_GENERIC': {'indexName': 'test__gff_'+SEARCH_SUFFIX, 'indexType': 'gff',
                       'indexGFF': SEARCH_TEST_DATA_PATH+'test.gff.gz', 'shards': 1},
       'GTF_GENERIC': {'indexName': 'test__gtf_'+SEARCH_SUFFIX, 'indexType': 'gtf',
                       'indexGFF': SEARCH_TEST_DATA_PATH+'test.gtf.gz', 'isGTF': True, 'shards': 1},
       'GFF_ERR': {'indexName': 'test__err__gff_'+SEARCH_SUFFIX, 'indexType': 'gff',
                   'indexGFF': SEARCH_TEST_DATA_PATH+'test_error.gff.gz', 'shards': 1},
       'GENE_TARGET': {'indexName': 'test__gene_target_'+SEARCH_SUFFIX,
                       'indexGTarget': SEARCH_TEST_DATA_PATH+'gene_targets.tab.gz', 'shards': 1},
       'T1D_CRITERIA': {'indexName': 'test__t1d_criteria_'+SEARCH_SUFFIX, 'indexProject': 't1dbase',
                        'indexCriteria': 'true', 'applyFilter': '1', 'shards': 1},
